...
public class PlusExpression extends BinaryExpression {
    ...
    public int value() {
		...
		//.value() returns value for IntConstant. E.g. PlusExpression.getLeft() (i.e. BinaryExpression)
		//returns Left value, which is IntConstant, and .value() is the int value of IntConstant
    }
